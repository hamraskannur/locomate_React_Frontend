  ...
  return (
    <div className="z-50 flex justify-between bg-heavy-metal-800 shadow-md w-full bg-slate-700 h-16 shadow-heavy-metal-400 p-4 top-0 sticky">
      ...
      <div className="flex gap-3  items-center">
       ...
       {showToggle && <div className=" w-40 mr-2 rounded-md  ml-auto mt-14 border-2 h-24 bg-white fixed overflow-x-hidden overflow-y-auto  inset-0 z-50 outline-none focus:outline-none">
          <Link
            to="/settings"
