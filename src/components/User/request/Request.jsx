...
const Request = () => {
  ...
  return (
    <>
    {request.length>0  && <div className="p-5 py-1 top-24 ">
      <div
        className=" bg-white  shadow:lg shadow-gray-300 rounded-md p-4 mb-5   mt-6 ">
        <h2 className="text-gray-400 mb-5">You have a requests</h2>
        <div className="flex gap-2 flex-wrap ">
            {
        request.map((item)=>( <Card data={item.Requests[0]} functionName={acceptReq} button={"Accept"} request={true} deleteReq={deleteReq} />))
            }
